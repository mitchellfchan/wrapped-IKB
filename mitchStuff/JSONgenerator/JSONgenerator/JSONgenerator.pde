...
void setup() {
  ...
  String imagehash = "th1s1sAn1m@geH@$#";
  ...
  String image = "https://ifps.io/ipfs/" + imagehash;

  masterJson.setString("image", image);

  String description = "Transferable wrapper for a single non-fungible IKB token, the first non-fungible token ever exhibited in a physical art gallery.";
  ...
  String[] values = {"Mitchell F. Chan", 
    "S", 
    "E", 
    "InterAccess, Toronto. August 29, 2017.", 
...
superRareMedia.setString("size", "TEMPORARY"); 
